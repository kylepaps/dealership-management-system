        ...
        <div className='flex flex-col justify-between items-start w-full h-body overflow-hidden'>
            <div className='flex flex-row h-64 space-x-2 w-full px-4'>
                <div className='h-full w-full bg-white bg-opacity-90 rounded-xl shadow-md overflow-auto'>
                    <div className='flex flex-col w-full h-full justify-between p-6'>
                        <div className='flex justify-start'>
                            <svg className="w-12 h-12 bg-gradient-to-br from-white via-indigo-400 to-indigo-400 bg-opacity-50 text-indigo-900 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='h-full w-full bg-white bg-opacity-90 rounded-xl shadow-md overflow-auto'>
                    <div className='flex flex-col w-full h-full justify-between p-6'>
                        <div className='flex justify-start'>
                            <svg className="w-12 h-12 bg-gradient-to-bl from-white via-orange-400 to-orange-400 bg-opacity-50 text-orange-900 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='h-full w-full bg-white bg-opacity-90 rounded-xl shadow-md overflow-auto'>
                    <div className='flex flex-col w-full h-full justify-between p-6'>
                        <div className='flex justify-start'>
                            <svg className="w-12 h-12 bg-gradient-to-br from-white via-green-400 to-green-400 bg-opacity-50 text-green-900 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
