        ...
        <div className='flex flex-col justify-between items-start w-full h-body overflow-hidden'>
            <div className='flex flex-row h-64 space-x-2 w-full px-4'>
                <div className='h-full w-full bg-white bg-opacity-90 rounded-xl shadow-md overflow-auto'>
                    <div className='flex flex-col w-full h-full justify-between p-6'>
                        <div className='flex justify-start'>
                            <svg className="w-12 h-12 bg-gradient-to-br from-indigo-50 via-indigo-400 to-indigo-400 bg-opacity-50 text-indigo-900 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='h-full w-full bg-white bg-opacity-90 rounded-xl shadow-md overflow-auto'>
                    <div className='flex flex-col w-full h-full justify-between p-6'>
                        <div className='flex justify-start'>
                            <svg className="w-12 h-12 bg-gradient-to-bl from-orange-50 via-orange-400 to-orange-400 bg-opacity-50 text-orange-900 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                            </svg>
                        </div>
                        <div className='flex justify-center p1-2'>
                            <h1 className='flex font-Poppins font-normal text-3xl text-orange-900'>Available Inventory</h1>
                        </div>
                        <div className='flex flex-col justify-end pr-4'>
                            <h1 className='flex font-Poppins font-semibold text-3xl justify-end text-orange-900'>{unissuedCount}</h1>
                        </div>
                ...
                <div className='h-full w-full bg-white bg-opacity-90 rounded-xl shadow-md overflow-auto'>
                    <div className='flex flex-col w-full h-full justify-between p-6'>
                        <div className='flex justify-start'>
                            <svg className="w-12 h-12 bg-gradient-to-br from-green-50 via-green-400 to-green-400 bg-opacity-50 text-green-900 rounded-full p-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
                        <div className='flex justify-center p1-2'>
                            <h1 className='flex font-Poppins font-normal text-3xl text-green-900'>Monthly Revenue</h1>
                        </div>
                        <div className='flex flex-col justify-end pr-4'>
                            <h1 className='flex font-Poppins font-semibold text-3xl justify-end text-green-900'>$12,453</h1>
                        </div>
