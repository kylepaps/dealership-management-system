        ...
        <div className='flex flex-col w-full justify-between p-6'>
            <form className='bg-white bg-opacity-90 rounded-xl p-2 shadow-md w-full' onSubmit={handleSubmit(onSubmit)}>
                <div className='flex flex-col'>
                  <h1 className='p-4 font-Poppins font-semibold text-xl text-neutral-700'>Create Vehicle</h1>
                  <div className='flex vehicle-form:flex-row flex-col p-4 vehicle-form:space-x-4 justify-between'>
                    <div className='flex flex-col w-full'>
                      ...
                      <input className={errors.make?.type === 'required' ? 'rounded-md border-2 border-red-700 focus:outline-none p-1 placeholder:border-red-700 font-Poppins font-light' : 'rounded-md border-2 border-neutral-300 outline-neutral-500 p-1 focus:outline-indigo-500 font-Poppins font-light'} placeholder={errors.make?.type === 'required' ? 'Make is required' : null} type='text' {...register("make", { required: true })}></input>
                    </div>
                    <div className='flex flex-col w-full'>
                    <div><label className='text-sm font-Poppins font-semibold text-neutral-600'>Model</label><label className='font-Poppins font-semibold text-sm text-red-600'> *</label></div>
                      <input className={errors.model?.type === 'required' ? 'rounded-md border-2 border-red-700 focus:outline-none p-1 placeholder:border-red-700 font-Poppins font-light' : 'rounded-md border-2 border-neutral-300 outline-neutral-500 p-1 focus:outline-indigo-500 font-Poppins font-light'} placeholder={errors.model?.type === 'required' ? 'Model is required' : null} type='text' {...register("model", { required: true })}></input>
                    </div>
                    <div className='flex flex-col w-full'>
                      ...
                      <select className='rounded-md border-2 border-neutral-300 outline-neutral-500 p-1 focus:outline-indigo-500 selection:outline-indigo-500 font-Poppins font-light' {...register("type")}>
                        <option value="COMMERCIAL" className='font-Poppins font-light'>Commercial</option>
                        <option value="PICKUP" className='font-Poppins font-light'>Pickup</option>
                        <option value="SUV" className='font-Poppins font-light'>SUV</option>
                        <option value="MINIVAN" className='font-Poppins font-light'>Minivan</option>
                        <option value="SPORTSCAR" className='font-Poppins font-light'>Sportscar</option>
                        <option value="CAR" className='font-Poppins font-light'>Car</option>
                      </select>
                    </div>
                    <div className='flex flex-col w-full'>
                    <div><label className='text-sm font-Poppins font-semibold text-neutral-600'>Year (2010 - 2023)</label><label className='font-Poppins font-semibold text-sm text-red-600'> *</label></div>
                      <input className={errors.year?.type === 'required' ? 'rounded-md border-2 border-red-700 focus:outline-none p-1 placeholder:border-red-700 font-Poppins font-light' : 'rounded-md border-2 border-neutral-300 outline-neutral-500 p-1 focus:outline-indigo-500 font-Poppins font-light'} placeholder={errors.year?.type === 'required' ? 'Year is required' : null} type='number' {...register("year", { required: true, min:2010, max:2023 })}></input>
                    </div>
                    <div className='flex flex-col w-full'>
                      ...
                      <input className={errors.price?.type === 'required' ? 'rounded-md border-2 border-red-700 focus:outline-none p-1 placeholder:border-red-700 font-Poppins font-light' : 'rounded-md border-2 border-neutral-300 outline-neutral-500 p-1 focus:outline-indigo-500 font-Poppins font-light'} placeholder={errors.price?.type === 'required' ? 'Price is required' : null} type='number' {...register("price", { required: true, min: 15 })}></input>
                    </div>
                  </div>
            ...
            <div className='flex flex-col p-6 bg-white bg-opacity-90 my-6 rounded-xl shadow-md'>
              <div className='flex flex-row justify-between'>
                <h1 className='font-Poppins font-semibold text-xl text-neutral-700'>Vehicles</h1>
                <div className='flex flex-col'>
              ...
              <div className='flex flex-row border-b-2 border-indigo-500 border-opacity-50 justify-between items-center pt-6'>
                ...
                <h1 className='w-full px-2 font-Poppins font-medium text-neutral-800'>Make</h1>
                <h1 className='w-full px-2 font-Poppins font-medium text-neutral-800'>Model</h1>
                <h1 className='w-full px-2 font-Poppins font-medium text-neutral-800'>Type</h1>
                <h1 className='w-full px-2 font-Poppins font-medium text-neutral-800'>Year</h1>
                <h1 className='w-full px-2 font-Poppins font-medium text-neutral-800'>Price Per Day</h1>
                <div className='w-full px-4'></div>
              </div>  
              <div className='pt-3'>
