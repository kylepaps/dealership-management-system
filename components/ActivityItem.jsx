    ...
    if (firstName) {
            ...
            <div className='flex flex-row justify-center py-2 hover:bg-indigo-100 rounded-md'>
                ...
                <div className='flex w-full justify-center'>
                    <div className='flex flex-col w-32 justify-start'>
                        <h1 className='flex text-sm font-Poppins font-semibold text-neutral-800'>{firstName} {lastName}</h1>
                ...
                <div className='w-full flex px-4 justify-end items-center'>
                    <h1 className='font-Poppins text-sm font-normal text-neutral-800'>{actionedDate}</h1>
                </div>
            </div>
        )
    } else if (make) {
        return (
            <div className='flex flex-row justify-between py-2 hover:bg-indigo-100 rounded-md'>
                ...
                <div className='flex w-full justify-center'>
                    <div className='flex flex-col w-32 justify-start'>
                        <h1 className='flex text-sm font-Poppins font-semibold text-neutral-800'>{make} {model}</h1>
        ...
        return (
            <div className='flex flex-row justify-center py-2 hover:bg-indigo-100 rounded-md'>
                ...
                <div className='flex w-full justify-center'>
                    <div className='flex flex-col w-32 justify-start'>
                        <h1 className='flex text-sm font-Poppins font-semibold text-neutral-800'>{issuedMake} {issuedModel}</h1>
