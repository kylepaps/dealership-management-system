...
export default function Projects(props) {
  ...
  const [vehicleData, setVehicleData] = useState(props.vehicles)
  const [sortType, setSortType] = useState('make')
  ...
  useEffect(() => {
    const sortArray = type => {
      ...
      const sorted = [...props.vehicles].sort(function(a, b) {
...
export const getServerSideProps = async () => {
  ...
  const stringCarData = JSON.stringify(carData)
  const vehicles = JSON.parse(stringCarData)
